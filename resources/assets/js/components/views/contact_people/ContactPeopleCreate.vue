...
<template>
    <div id="contact-people-create">
        <form-panel ref="formPanel" method="post" action="/contact-people" :model="contact_person" :horizontal="true" @submitted="preview">
            <template slot="title">Buat <i>Contact Person</i></template>
