...
<template>
    <div id="html-contents-create">
        <form-panel ref="formPanel" method="post" action="/html-contents" :model="html_content" :horizontal="true" @submitted="preview">
            <template slot="title">Buat Konten</template>
