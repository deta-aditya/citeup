...
class PutQuestionsTest extends TestCase
{
    use TestAssistant;
    ...
    public function test200Admin()
    {
        ...
        $response = $this->requestToApi(
            $user, 'PUT', '/questions/'. $question->id, $this->randomQuestionData()
        );
     ...
     * @return array
     */
    protected function randomQuestionData($entry = null)
    {
